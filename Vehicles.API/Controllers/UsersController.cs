...
namespace Vehicles.API.Controllers
{
    ...
    public class UsersController : Controller
    {
        ...
        public UsersController(DataContext context, IUserHelper userHelper, IComboHelper comboHelper, IConverterHelper converterHelper, IBlobHelper blobHelper, IMailHelper mailHelper)
        {
            _context = context;
        ...
        public async Task<IActionResult> Create(UserViewModel model)
        {
            ...
            model.DocumentTypes = _comboHelper.GetComboDocumentTypes();
            return View(model);
        }
        ...
        public async Task<IActionResult> AddVehicle(string id)
        {
            ...
            {
                Brands = _comboHelper.GetComboBrands(),
                UserId = user.Id,
        ...
        public async Task<IActionResult> AddVehicle(VehicleViewModel vehicleViewModel)
        {
            ...
            vehicleViewModel.Brands = _comboHelper.GetComboBrands();
            vehicleViewModel.VehicleTypes = _comboHelper.GetComboVehicleTypes();
        ...
        public async Task<IActionResult> AddDetail(int? id)
        {
            ...
            DetailViewModel model = new DetailViewModel
            {
                ...
                Procedures = _comboHelper.GetComboProcedures()
            };
        ...
        public async Task<IActionResult> AddDetail(DetailViewModel detailViewModel)
        {
            ...
            detailViewModel.Procedures = _comboHelper.GetComboProcedures();
